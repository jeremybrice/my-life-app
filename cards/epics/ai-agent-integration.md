...
children:
- story-030-chat-ui-layout-and-message-thread
- story-031-claude-api-client-integration
- story-032-network-connectivity-detection-and-graceful-degrad
- story-033-api-key-validation
- story-034-natural-language-expense-parsing
- story-035-expense-confirmation-and-data-store-write
- story-036-image-upload-and-receipt-processing
- story-037-transient-image-handling-and-user-disclosure
- story-038-conversation-context-management
