...
export function ChatInput({ onSendMessage, onImageUpload, disabled = false, loading = false, placeholder = 'Describe an expense...', showImageUpload = true }: ChatInputProps) {
